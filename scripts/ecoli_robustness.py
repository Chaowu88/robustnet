...
PERTURB_ENZYMES = [
    ...
    'PYK', 'PPS', 'PDH', 'LDH', 'PFL', 'PTA', 'ACK', 'ALDDH', 'ALCD', 'G6PD', 'PGL', 
    'GND', 'RPI', 'RPE', 'TKT', 'TAL', 'EDD', 'EDA', 'CS', 'ACON', 'ICD', 'AKGDH', 
    'SUCOAS', 'SDH', 'FUMS', 'MDH', 'ICL', 'MALS', 'ME1', 'ME2', 'PPC', 'PPCK', 
    'NDH1', 'NDH2', 'COX', 'ATPSyn', 'NNT', 'ADK'
]
